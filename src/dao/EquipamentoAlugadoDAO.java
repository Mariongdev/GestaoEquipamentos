...
public class EquipamentoAlugadoDAO {
    ...
    public List<EquipamentoAlugado> listarTodos() throws SQLException, ClassNotFoundException {
        ...
        String sql = "SELECT * FROM equipamentos_alugados ORDER BY nome COLLATE NOCASE ASC";
    ...
    // Agora o método adicionar propaga as exceções corretamente
    public void adicionar(EquipamentoAlugado equipamento) throws SQLException, ClassNotFoundException {
        inserir(equipamento);
    }
}
